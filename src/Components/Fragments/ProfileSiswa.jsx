      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-4">
          ...
          <div className="flex flex-col">
            ...
            <span className="font-medium">{profileData.data.nama_lengkap}</span>
          </div>
          <div className="flex flex-col">
            <span className="text-sm text-gray-500">Nomor Induk Siswa</span>
            <span className="font-medium">{profileData.data.nis}</span>
          </div>
          <div className="flex flex-col">
          ...
          <div className="flex flex-col">
            ...
            <span className="font-medium">
              Kelas {profileData.data.id_kelas}
            </span>
          </div>
          <div className="flex flex-col">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col">
            ...
            {isEditing ? (
              <input
                type="text"
                value={editedData.alamat ?? profileData.data.alamat}
                onChange={(e) =>
          ...
          <div className="flex flex-col">
            ...
            {isEditing ? (
              <input
                type="tel"
                value={editedData.no_telp ?? profileData.data.no_telp}
                onChange={(e) =>
          ...
          <div className="flex flex-col">
            ...
            {isEditing ? (
              <input
                type="email"
                value={editedData.email ?? profileData.data.user.email}
                onChange={(e) =>
